...
img = cv2.imread('C:/pill/croll11.jpg',cv2.IMREAD_COLOR)
imgcolorc, imgcolors, imgshape,colorname = image_processing(img)
cv2.imshow("colorc",imgcolorc)
cv2.imshow("colors",imgcolors)
cv2.imshow("shape",imgshape)
# print(colorname)

cv2.imwrite("C:/Download/colorcpill7.jpg", imgcolorc)
cv2.imwrite("C:/Download/colorspill7.jpg", imgcolors)
cv2.imwrite("C:/Download/shapepill7.jpg", imgshape)
