...
img = cv2.imread('C:/pill/croll7.jpg',cv2.IMREAD_COLOR)
imgcolorc, imgcolorf, imgshape,colorname = image_processing(img)
cv2.imshow("colorc",imgcolorc)
cv2.imshow("colorf",imgcolorf)
cv2.imshow("shape",imgshape)


cv2.imwrite("C:/Download/colorcpill7.jpg", imgcolorc)
cv2.imwrite("C:/Download/colorfpill7.jpg", imgcolorf)
